...
<html lang="en-US">
    <head>
        <title>Thank you | video-downloader</title>
        <meta charset="UTF-8">
            ...
            <div class="banner-backround">
                <div class="container">
                    <div class="banner-text">
                        ...
                        <button type="button" class="btn btn-warning text-dark btn-banner" onclick="location.href='http://localhost/video-downloader/';">Try Another ?</button>
                    </div>
                </div>
            </div>
        </div>
